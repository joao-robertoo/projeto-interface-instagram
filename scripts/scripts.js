...
if (value === "" || value.length < 6) { button.style.backgroundColor="#B2DFFC" ; show.style.display="none" ; } else {
  button.style.backgroundColor="#0095F6" ; show.style.display="block" ; } button.addEventListener("click", ()=> {
  password.value = "";
  user.value = "";
